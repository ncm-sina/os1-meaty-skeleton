...
// Feature flags for common CPU features (from CPUID leaf 0x1)
#define FEATURE_SSE2  (1U << 26)  // EDX bit 26: SSE2 support
#define FEATURE_AVX   (1U << 28)  // ECX bit 28: AVX support
